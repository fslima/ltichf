...
MEDIA_ROOT = '/opt/github/ltichf/media/'		#Mapeada pasta dos arquivos de media

MEDIA_URL = 'ltichf.medi'		#Mapeada pasta dos arquivos de media
...
ROOT_URLCONF = 'ltichf.urls'			#mapeado arquivo das urls do projeto
